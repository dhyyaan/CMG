...
import com.think360.cmg.databinding.EditProfileBinding;
import com.think360.cmg.manager.ApiService;
import com.think360.cmg.presenter.EditProfilePresenter;
...
public class ProfileFragment extends Fragment implements View.OnClickListener, EditProfilePresenter.View {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (!TextUtils.isEmpty(AppController.sharedPreferencesCompat.getString(AppConstants.WORKER_NAME, ""))) {
            editProfileBinding.editName.setText(AppController.sharedPreferencesCompat.getString(AppConstants.WORKER_NAME, ""));
            editProfileBinding.tvName.setText(AppController.sharedPreferencesCompat.getString(AppConstants.WORKER_NAME, ""));
        }
